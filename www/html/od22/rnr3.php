    ...
    <div class="bg-home px-8 w-full">
        <div class="
            ...
            <div class="mt-12 text-white text-center">
                <p>Click the "Generate" button to get the <b>Ringing No Response-3 Template</b></p><br>
            </div>
            <div class="text-white text-center">
            ...
            <br>
            <div>
                <div class="text-center"><b>RNR Schedule: -NIL-</b></div><br>
                <div class="text-white text-center">
                    <p>No MW Solve the Case or Form Fillup</p>
                </div>
                <br>
                <hr><br>
                <p><b>OD: RNR 3. case solved. unable to send email.</b></p><br>
                <p><b>OD: RNR 3. Activity log inactive, hence couldn't solve the case and mentioned over the notes. Mark waiting done for 24 hours. Form fill up done.</b></p><br>
		...
		md:mt-0 md:rounded-l-none md:w-48
         ">
                ...
                <p id="myInput2">Hi <var id="mynam"><var id="name"><b>_CX Name_</b></var></var>,<br><br> We tried reaching you about your order for <var id="mypro1"><var id="prname1"><b>_Product Name_</b></var>,</var> but were unable to get in touch with you. We are sorry to let you know that the couriers have confirmed that there will be a further delay in the delivery of your order. We understand if you do not want to wait, you can choose to cancel your order by clicking My Orders page. Please note that you can choose to place a fresh order for this item within the next 7days and in case the price of the product has increased, we will reach out to you, for support. Since you waited for a long time to get this product, if the price of the product remains the same/has reduced, 10% will be given of the product value will be added to your Flipkart account by the seller within 72 hours of the order delivery.</br>
                    <br>
		...
		md:mt-0 md:rounded-l-none md:w-48
         ">
                ...
                <br>
                <hr><br>
                <p><b> OD: RNR 3. case solved. Email sent.</b></p><br>
                <hr>
                </p>
            </div>
